...
```{r readTarget}
target <- read.csv("~/Escritorio/BDBI/Second year/tercer trimestre/Lab2OMICS/taget.txt", sep= "")
expresion <- as.matrix(read.delim("~/Escritorio/BDBI/Second year/tercer trimestre/Lab2OMICS/expresion.txt", row.names = 1))
```
